<template><div><h2 id="差分进化算法-differential-evolution-de-概述" tabindex="-1"><a class="header-anchor" href="#差分进化算法-differential-evolution-de-概述"><span>差分进化算法（Differential Evolution，DE）概述</span></a></h2>
<ul>
<li>
<p>Storn等人1995年提出</p>
</li>
...
<td>0<sub>2，一般在0.4</sub>1有效，通常为0.5</td>
</tr>
<tr>
<td>CR</td>
<td>交叉算子</td>
...
<figure><img src="@source/basic_knowledge/smart/ACO/image-3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>个体表示：<br>
<img src="@source/basic_knowledge/smart/ACO/image-4.png" alt="" loading="lazy"></p>
<pre><code> 其中，i表示个体在种群中的序列
</code></pre>
<p>变量边界：
<img src="@source/basic_knowledge/smart/ACO/image-6.png" alt="" loading="lazy"></p>
<p>随机选择常用方法：</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>变异</strong>：</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>交叉</strong>：</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>即，若编码第j位处按照概率CR(或j=随机选择的某个维度)变成$v_{ji,G+1}$。</p>
...
<p>自适应算法中F为：</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>还可以设计一个随机范围的交叉算子CR：</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-10.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="离散差分进化算法" tabindex="-1"><a class="header-anchor" href="#离散差分进化算法"><span>离散差分进化算法</span></a></h3>
<p>改进用于整数规划和混合整数规划。</p>
<figure><img src="@source/basic_knowledge/smart/ACO/image-11.png" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure>
